...
if __name__ == '__main__':
	...
	H = up_projection_unit(features, up_ratio=UP_RATIO,scope='up_projection_unit', is_training=True)

	coord = conv2d(H, 64, [1, 1],
	...
	outputs = gather_point(outputs, farthest_point_sample(2048, outputs))
